  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Phát triển ứng dụng iOS}{7\textbf{/}2020 \textbf{--} Nay}
        \resumeItemListStart
            \resumeItem{Sử dụng Swift, kiến trúc MVC, MVVM, UIKit, Autolayout, RxSwift, Alamofire, ... để phát triển ứng dụng lấy/giao hàng dành cho tài xế.}
            \resumeItem{Tham gia phát triển thư viện nội bộ sử dụng cho các ứng dụng khác nhau như Map, News, Ví.}
